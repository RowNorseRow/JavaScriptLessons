...
function ClassTwo(name, pw, mail){
  ...
  this.password = pw;
  this.email = mail;
  this.checkPassword = function(pswrd){
    return this.password === pswrd;
  };

}

//These next two lines I created to test the functions.
//let user = new ClassTwo('Allen', 21, 'blah@gamil.com');
//console.log(user.checkPassword(21));
